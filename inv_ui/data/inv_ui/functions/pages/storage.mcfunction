...
# UI設置
    ...
    # ストレージ
        item replace entity @s inventory.11 with chest{Ui:501,UiItem:1b}
        item modify entity @s inventory.11 inv_ui:storage/storage

    # 素材
        item replace entity @s inventory.15 with barrel{Ui:502,UiItem:1b}
        item modify entity @s inventory.15 inv_ui:storage/material

# タグセット
    tag @s add ui_storage