...
#4P
    scoreboard players set @s ok_page 4
...
#チェスト付きトロッコに商品を置く
    ...
    ##商品(スコアに応じて)
    #キャンディ300
    item replace entity @n[tag=foodshop] container.10 from block 1 -63 1 container.10
    #わたあめ600
    item replace entity @n[tag=foodshop] container.13 from block 1 -63 1 container.11
    #ロリポップ1200
    item replace entity @n[tag=foodshop] container.16 from block 1 -63 1 container.12
