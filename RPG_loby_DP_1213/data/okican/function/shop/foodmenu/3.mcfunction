...
#3P
    scoreboard players set @s ok_page 3
...
#チェスト付きトロッコに商品を置く
    ...
    ##商品(スコアに応じて)
    #ドーナツ200
    item replace entity @n[tag=foodshop] container.10 from block 1 -63 1 container.7
    #カヌレ400
    item replace entity @n[tag=foodshop] container.13 from block 1 -63 1 container.8
    #ケーキ100
    item replace entity @n[tag=foodshop] container.16 from block 1 -63 1 container.9
