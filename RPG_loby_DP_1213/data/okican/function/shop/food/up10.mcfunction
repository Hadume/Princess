...
#購入
    item replace entity @n[tag=shopchest] container.15 from entity @s player.cursor
    ...
    scoreboard players add @s ok_shopcount 10
    
    item modify entity @n[tag=shopchest] container.13 okican:shop/add10
