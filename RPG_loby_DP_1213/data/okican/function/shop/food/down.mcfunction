...
#購入
    item replace entity @n[tag=shopchest] container.12 from entity @s player.cursor
    ...
    scoreboard players remove @s ok_shopcount 1

    item modify entity @n[tag=shopchest] container.13 okican:shop/remove
