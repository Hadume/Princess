...
## 装備が変更されたか確認
  execute store success storage main:temp Updated byte 1 run data modify storage data:player _[-4][-4][-4][-4][-4][-4][-4][-4].Mainhand set from storage main:temp Mainhand
## 装備の効果を反映
