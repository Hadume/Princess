...
## 攻撃者のIDを保存
	execute if entity @s[type=player] run data modify storage data:player _[-4][-4][-4][-4][-4][-4][-4][-4].AttackBy append from storage temp: Magic.CasterID
	execute if entity @s[type=!player] run data modify storage data:entity _[-4][-4][-4][-4][-4][-4][-4][-4].AttackBy append from storage temp: Magic.CasterID
