...
## スコアを代入
  execute store result score @s Mgc.Duration run data get storage asset:magic Duration
## 速度を代入
...
## プレイヤーのIDを保存
  data modify storage data:entity _[-4][-4][-4][-4][-4][-4][-4][-4].Magic.CasterID set from storage asset:temp CasterID
## 初期化tagを削除
