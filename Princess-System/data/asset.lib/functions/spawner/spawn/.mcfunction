...
## 何体スポーンさせるか
  ### 数値を取得
    execute store result score #Count.Min Temp run data get storage asset:temp dataCopy.Count.Min
    execute store result score #Count.Max Temp run data get storage asset:temp dataCopy.Count.Max
  ### ランダム
