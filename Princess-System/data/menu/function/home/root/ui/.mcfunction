...
##
    ### 1行目
        loot replace entity @s inventory.0 loot menu:frame.black
    ...
    ### 2行目
        ...
        loot replace entity @s inventory.10 loot menu:home/skilltree
        loot replace entity @s inventory.11 loot menu:home/equipment
        loot replace entity @s inventory.12 loot menu:home/magic
        loot replace entity @s inventory.13 loot menu:home/status
        loot replace entity @s inventory.14 loot menu:home/storage
        loot replace entity @s inventory.15 loot menu:home/quest
        loot replace entity @s inventory.16 loot menu:home/communicate
