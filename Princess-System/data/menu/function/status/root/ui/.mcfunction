...
##
    ...
    ### 2行目
        ...
        loot replace entity @s inventory.12 loot menu:status/basis
        loot replace entity @s inventory.13 loot menu:status/element
        loot replace entity @s inventory.14 loot menu:status/magic
