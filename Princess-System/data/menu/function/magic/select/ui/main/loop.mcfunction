...
## データを消す
	execute in overworld run item replace block 0 -64 0 container.0 with air
...
## アイテムを設定
	execute if items block 0 -64 0 container.0 * in overworld run function menu:magic/select/ui/main/icon
