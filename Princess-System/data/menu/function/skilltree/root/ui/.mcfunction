#> menu:skilltree/root/ui/
#
# @within function menu:-common/repair

say skilltree:root.ui
...
##
	### 1行目
		...
		loot replace entity @s inventory.4 loot menu:skilltree/point
	...
	### 2行目
		...
		loot replace entity @s inventory.11 loot menu:skilltree/flamme
		loot replace entity @s inventory.12 loot menu:skilltree/wind
		loot replace entity @s inventory.13 loot menu:skilltree/wasser
		loot replace entity @s inventory.14 loot menu:skilltree/licht
		loot replace entity @s inventory.15 loot menu:skilltree/dunkel
