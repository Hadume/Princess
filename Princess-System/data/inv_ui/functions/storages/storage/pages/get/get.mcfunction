...
#   get item id data
# @private
# @within function inv_ui:storages/storage/get_item

# data get
    # data modify
        # slot
            $execute store result score @s ui_storage_slot run data get storage player: _[-4][-4][-4][-4][-4][-4][-4][-4].storage.page$(page).slot[$(value)]
        ...
        # id
            $data modify storage ui:storage id set from storage player: _[-4][-4][-4][-4][-4][-4][-4][-4].storage.page$(page).id[$(value)]
        # count
            $data modify storage ui:storage count set from storage player: _[-4][-4][-4][-4][-4][-4][-4][-4].storage.page$(page).count[$(value)]
        # tag
            data modify storage ui:storage tag set value {}
            $data modify storage ui:storage tag set from storage player: _[-4][-4][-4][-4][-4][-4][-4][-4].storage.page$(page).tag[$(value)]
    # run
