...
#   アイテムを表示する
# @within function inv_ui:pages/storage/storage

# 保存されたデータのリスト長を取得
    $execute store result score @s ui_storage_length run data get storage player: _[-4][-4][-4][-4][-4][-4][-4][-4].storage.page$(page).id
