...
# 魔法スロット
	...
	## 魔法2
		item replace entity @s inventory.12 with yellow_stained_glass_pane{UICode:null,UiItem:1b}
	## 魔法3
		item replace entity @s inventory.14 with yellow_stained_glass_pane{UICode:null,UiItem:1b}
	## 魔法4
		item replace entity @s inventory.15 with yellow_stained_glass_pane{UICode:null,UiItem:1b}

# クリスタルスロットロック
        item replace entity @s inventory.11 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.12 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.13 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.14 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.15 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.20 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.21 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.22 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.23 with red_stained_glass_pane{UICode:null,UiItem:1b}
        item replace entity @s inventory.24 with red_stained_glass_pane{UICode:null,UiItem:1b}
