...
## MP,HPの回復
  execute if score @s MP.Rcvr.Timer matches 1.. run function lib:mp/recover/tick
  execute if score @s HP.Rcvr.Timer matches 1.. run function lib:hp/recover/tick
## ステータス表示
