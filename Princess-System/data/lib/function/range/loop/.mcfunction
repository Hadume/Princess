...
## 座標を取得
	### 魔法
		execute store result score #Pos.X1 Temp run data get storage temp: Pos[0] 1000
		execute store result score #Pos.Y1 Temp run data get storage temp: Pos[1] 1000
		execute store result score #Pos.Z1 Temp run data get storage temp: Pos[2] 1000
