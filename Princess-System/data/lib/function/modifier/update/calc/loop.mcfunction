...
## 例外処理
    execute if data storage lib: {Stat:"hpMax"} run function lib:stats/update/calc/hp.max
    execute if data storage lib: {Stat:"mpMax"} run function lib:stats/update/calc/mp.max
