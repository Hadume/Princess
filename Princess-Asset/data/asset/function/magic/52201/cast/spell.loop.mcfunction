#> asset:magic/52201/cast/spell.loop
# 魔法の本体
...
## 本体を召喚
    execute anchored eyes run summon armor_stand ^ ^ ^ {Passengers:[{id:"block_display",block_state:{Name:"tube_coral_block"},Tags:["spellInit","spellDisplay"]}],Tags:["spell","spellInit"]}
