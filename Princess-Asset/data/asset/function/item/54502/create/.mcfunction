...
## 説明? : [TextComponent] @ N
	data modify storage asset:item Lore set value [{"text": "体力が50回復する","color": "blue"}]
...
## 追加効果? : [{Name: Food, Amount: int, Duration: int}] @ N
	data modify storage asset:item Effects append value {Name:"HP",Amount:50,Duration:1}
