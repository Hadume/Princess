...
## 名前 : TextComponent
    data modify storage asset:item Name set value '{"text": "キャンディ","color":"yellow"}'

## 説明? : [TextComponent] @ N
    data modify storage asset:item Lore set value [{"text": "魔法攻撃力が60秒間5up!","color": "blue"}]
...
## ItemModel? : String
    data modify storage asset:item ItemModel set value "food/candy"
