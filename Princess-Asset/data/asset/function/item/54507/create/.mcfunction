...
## 説明? : [TextComponent] @ N
	data modify storage asset:item Lore set value [{"text": "攻撃力が60秒間10up!","color": "blue"}]
...
## 追加効果? : [{Name: Food, Amount: int, Duration: int}] @ N
	data modify storage asset:item Effects append value {Name:"ATK",Amount:10,Duration:1200}
