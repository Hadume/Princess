...
## 名前 : TextComponent
	data modify storage asset:item Name set value '{"text": "ベジタブルジュース","color":"yellow"}'

## 説明? : [TextComponent] @ N
	data modify storage asset:item Lore set value [{"text": "防御力が60秒間10up!","color": "blue"}]
...
## ItemModel? : String
	data modify storage asset:item ItemModel set value "food/vegetable_juice"
...
## 追加効果? : [{Name: Food, Amount: int, Duration: int}] @ N
	data modify storage asset:item Effects append value {Name:"DEF",Amount:10,Duration:1200}
