...
# 
# @within function asset:magic/52101/cast/check.mp

## 本体を召喚
  summon armor_stand ~ ~ ~ {FallDistance:-4096f,NoGravity:0b,Invulnerable:1b,Silent:1b,Invisible:1b,NoBasePlate:1b,ArmorItems:[{},{},{},{id:"magma_block",Count:1b}],Pose:{Head:[180f,0f,0f]},Small:1b,Tags:["Spell","Spell.Init"]}
## 魔法名; JsonText
