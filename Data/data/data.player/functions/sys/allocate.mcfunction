...
execute store result score #_ PlayerID run data get storage data:player id[-1]
...
# 割り当てIDに追加
data modify storage data:player id append value -1
execute store result storage data:player id[-1] int 1 run scoreboard players get #_ PlayerID
# 割り当てる
